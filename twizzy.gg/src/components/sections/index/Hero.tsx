      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl">
            Hey, I&apos;m Twizzy<span className="sm:hidden inline-block animate-wave ml-2">👋</span><span className="sm:inline-block hidden animate-wave ml-2">👋</span>
          </h1>
          <p className="font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["I'm a 17 year old full-stack developer located in Canada"],
                  loop: false,
                  autoStart: true,
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            ...
            />
            <SocialIcon
              url="https://www.youtube.com/@bigcheesh"
            ...
            />
            <SocialIcon
              url="https://guns.lol/bigcheesh"
              icon={<svg role="img" className="h-7 w-7 fill-neutral-400" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" /></svg>}
              delay={0.6}
            />
          </ul>
        </motion.div>
